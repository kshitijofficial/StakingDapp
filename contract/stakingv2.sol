...
contract Staking is ReentrancyGuard{
  ...
  function rewardPerToken() public view returns(uint){
    ...
    uint totalTime = block.timestamp.sub(lastUpdateTime);//1 sec
    uint totalRewards = REWARD_RATE.mul(totalTime); //10 tokens per second
...
//stake token - 0xff7A0222AA93a90FE079915EcA1f5Ec53c9AeFc5
//reward token - 0x5730D39603c06b44841cc5904A3B3ABC8Ae1013A
//staking contract - 0x1578b355aeB33401C8Cdc7438D5729CAc3ebD07A